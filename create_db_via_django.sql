...
--
CREATE TABLE "migrations_customer" ("user_ptr_id" bigint NOT NULL UNIQUE, "customer_id" integer NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "nric" varchar(8) NOT NULL UNIQUE, "email" varchar(254) NOT NULL UNIQUE, "date_of_birth" timestamp with time zone NOT NULL, "address" text NOT NULL, "phone_no" varchar NOT NULL UNIQUE);
--
-- Create model Teller
--
