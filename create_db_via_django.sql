...
-- Create model Log
--
CREATE TABLE "migrations_log" ("id" bigint NOT NULL PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY, "user_ptr_id" bigint NOT NULL, "date" timestamp with time zone NOT NULL, "data" varchar NOT NULL);
--
...
ADD CONSTRAINT "migrations_log_user_ptr_id_3bde43f7_fk_migrations_user_id" FOREIGN KEY ("user_ptr_id") REFERENCES "migrations_user" ("id") DEFERRABLE INITIALLY DEFERRED;
